...
$stmt = $conn->prepare("SELECT id_doctor, nombre, correo, especialidad, telefono FROM doctores WHERE id_doctor = ? LIMIT 1");
if ($stmt) {
      ...
      <div class="profile-info">
        ...
        <form method="POST" class="profile-edit-form">
          <label class="profile-input-group">
            ...
            <input type="text" value="<?php echo e($doctor['id_doctor']); ?>" readonly aria-readonly="true">
            <small>Identificador asignado al registrar tu cuenta.</small>
          </label>
