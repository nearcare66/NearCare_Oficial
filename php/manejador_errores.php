...
function mostrarPantallaError(
    ...
    int $codigoHttp = 400,
    string $accionSecundariaUrl = '/NearCare/index.php',
...
<head>
    ...
    <link rel="stylesheet" href="/NearCare/Css/pantalla-error.css?v=2">
    <link rel="icon" type="image/png" sizes="32x32" href="/NearCare/img/favicon_io%20%283%29/favicon-32x32.png">
</head>
<body class="error-page">
    <main class="error-card" role="alert" aria-live="assertive">
        <img class="error-logo" src="/NearCare/img/Designer%20%2816%29.png" alt="NearCare">
